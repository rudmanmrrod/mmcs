#############################################################################
# Makefile for building: XAMU
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  XAMU.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++ -o Makefile XAMU.pro
#############################################################################
...
SOURCES       = mainwindow.C \
		...
		formcargando.cpp \
		formcortoplazo.cpp qrc_images.cpp \
		moc_mainwindow.cpp \
...
$(TARGET): ui_formLoadMatrix.h ui_formvariablesexogenas.h ui_formexportmatrix.h ui_formencadenamientos.h ui_formcompararresultados.h ui_formcompararmnc.h ui_formincidenciai.h ui_formpreciosnohomogeneos.h ui_formexportreport.h ui_formViewMatrix.h ui_formdescomposicion.h ui_formcargando.h ui_formcortoplazo.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: XAMU.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ -o Makefile XAMU.pro
...
dist: 
	@test -d .tmp/XAMU1.0.0 || mkdir -p .tmp/XAMU1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/XAMU1.0.0/ && $(COPY_FILE) --parents img/images.qrc .tmp/XAMU1.0.0/ && $(COPY_FILE) --parents mainwindow.H formloadmatrix.H formviewmatrix.H stackwidget.H accountwidget.H formvariablesexogenas.h stackvariablesexogenas.h variableexogenawidget.h formexportmatrix.h formencadenamientos.h stackencadenamientos.h encadenamientoswidget.h formcompararresultados.h formcompararmnc.h formincidenciai.h formpreciosnohomogeneos.h stackpreciosnohomogeneos.h variablepnh.h genericFunctions.h formexportreport.h qcustomplot.h formdescomposicion.h formcargando.h formcortoplazo.h .tmp/XAMU1.0.0/ && $(COPY_FILE) --parents mainwindow.C main.C formloadmatrix.C formviewmatrix.C stackwidget.C accountwidget.C formvariablesexogenas.cpp stackvariablesexogenas.cpp variableexogenawidget.cpp formexportmatrix.cpp formencadenamientos.cpp stackencadenamientos.cpp encadenamientoswidget.cpp formcompararresultados.cpp formcompararmnc.cpp formincidenciai.cpp formpreciosnohomogeneos.cpp stackpreciosnohomogeneos.cpp variablepnh.cpp genericFunctions.cpp formexportreport.cpp qcustomplot.cpp formdescomposicion.cpp formcargando.cpp formcortoplazo.cpp .tmp/XAMU1.0.0/ && $(COPY_FILE) --parents formLoadMatrix.ui formvariablesexogenas.ui formexportmatrix.ui formencadenamientos.ui formcompararresultados.ui formcompararmnc.ui formincidenciai.ui formpreciosnohomogeneos.ui formexportreport.ui formViewMatrix.ui formdescomposicion.ui formcargando.ui formcortoplazo.ui .tmp/XAMU1.0.0/ && (cd `dirname .tmp/XAMU1.0.0` && $(TAR) XAMU1.0.0.tar XAMU1.0.0 && $(COMPRESS) XAMU1.0.0.tar) && $(MOVE) `dirname .tmp/XAMU1.0.0`/XAMU1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/XAMU1.0.0
...
moc_formcortoplazo.cpp: ui_formcortoplazo.h \
		formcortoplazo.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/rodrigo/Proyectos/Matrices/mmcs -I/home/rodrigo/Proyectos/Matrices/mmcs/Eigen -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/4.9 -I/usr/include/x86_64-linux-gnu/c++/4.9 -I/usr/include/c++/4.9/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.9/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.9/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include formcortoplazo.h -o moc_formcortoplazo.cpp

compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_formLoadMatrix.h ui_formvariablesexogenas.h ui_formexportmatrix.h ui_formencadenamientos.h ui_formcompararresultados.h ui_formcompararmnc.h ui_formincidenciai.h ui_formpreciosnohomogeneos.h ui_formexportreport.h ui_formViewMatrix.h ui_formdescomposicion.h ui_formcargando.h ui_formcortoplazo.h
compiler_uic_clean:
	-$(DEL_FILE) ui_formLoadMatrix.h ui_formvariablesexogenas.h ui_formexportmatrix.h ui_formencadenamientos.h ui_formcompararresultados.h ui_formcompararmnc.h ui_formincidenciai.h ui_formpreciosnohomogeneos.h ui_formexportreport.h ui_formViewMatrix.h ui_formdescomposicion.h ui_formcargando.h ui_formcortoplazo.h
...
ui_formcortoplazo.h: formcortoplazo.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic formcortoplazo.ui -o ui_formcortoplazo.h
...
formcortoplazo.o: formcortoplazo.cpp formcortoplazo.h \
		ui_formcortoplazo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o formcortoplazo.o formcortoplazo.cpp
...
moc_formcortoplazo.o: moc_formcortoplazo.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_formcortoplazo.o moc_formcortoplazo.cpp
