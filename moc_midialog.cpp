...
**
** Created: Mon Jun 22 11:11:42 2015
...
static const char qt_meta_stringdata_miDialog[] = {
    "miDialog\0\0on_pushButton_clicked()\0"
};

void miDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        miDialog *_t = static_cast<miDialog *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData miDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject miDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_miDialog,
      qt_meta_data_miDialog, &staticMetaObjectExtraData }
};
