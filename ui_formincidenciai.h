...
public:
    ...
    void setupUi(QWidget *FormIncidenciaI)
    {
        if (FormIncidenciaI->objectName().isEmpty())
            FormIncidenciaI->setObjectName(QStringLiteral("FormIncidenciaI"));
        ...
        TableIncidencia->setObjectName(QStringLiteral("TableIncidencia"));
        ...
        CalcularIncidencia->setObjectName(QStringLiteral("CalcularIncidencia"));
        ...
        CalcularIncidencia->setStyleSheet(QStringLiteral("background-color: #358ccb; color: #fff; font-weight: bold; height: 30px; border: none; border-radius: 5px; "));
