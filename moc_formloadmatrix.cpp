...
**
** Created: Fri Sep 25 11:00:34 2015
...
const QMetaObjectExtraData FormLoadMatrix::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FormLoadMatrix::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FormLoadMatrix,
      qt_meta_data_FormLoadMatrix, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FormLoadMatrix::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FormLoadMatrix))
