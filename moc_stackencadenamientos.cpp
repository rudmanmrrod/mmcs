...
**
** Created: Fri Sep 25 09:51:21 2015
...
static const char qt_meta_stringdata_stackEncadenamientos[] = {
    "stackEncadenamientos\0"
};
...
const QMetaObjectExtraData stackEncadenamientos::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject stackEncadenamientos::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_stackEncadenamientos,
      qt_meta_data_stackEncadenamientos, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &stackEncadenamientos::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_stackEncadenamientos))
